#
# Code adapted from https://github.com/dvlab-research/MiSLAS/blob/main/datasets/
#
...
class CIFAR10_LT(object):
    ...
    def __init__(self, distributed=False, root='/path/to/cifar10/', imb_type='exp',
...
class CIFAR100_LT(object):
    def __init__(self, distributed=False, root='/path/to/cifar100/', imb_type='exp',
                    imb_factor=0.01, batch_size=128, num_works=32):
        ...
        train_dataset = IMBALANCECIFAR100(root=root, imb_type=imb_type, imb_factor=imb_factor, rand_number=0, train=True, download=False, transform=train_transform)
